...
class siteb extends StatefulWidget {
  const siteb({super.key});

  @override
  State<siteb> createState() => _SiteaState();
}

class _SiteaState extends State<siteb> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Site B', style: TextStyle(color: Colors.white)),

...
class sitec extends StatefulWidget {
  final String userEmail;
  
  const sitec({super.key, required this.userEmail});

  @override
  State<sitec> createState() => _SitecState();
}

class _SitecState extends State<sitec> {
  // Données fictives pour Site B
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Monitoring - Site C', style: TextStyle(fontWeight: FontWeight.w600)),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                _buildOverviewStat(Icons.thermostat, "Température", "23°C", Colors.orange),
                _buildOverviewStat(Icons.opacity, "pH moyen", "6.95", Colors.blue),
                _buildOverviewStat(Icons.bubble_chart, "O₂ moyen", "6.3 mg/L", Colors.green),
              ],
            ),
          ],
        ),
